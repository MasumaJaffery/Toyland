...
<right><div class="col-xs-12 col-sm-12 col-md-6 top-search-holder">
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">

           <right> <input class="search-field" placeholder="Search Toys" name="product" required="required" /></right>
